 ...
 *
 */
public class ArxNodeNodePlugin extends Plugin {
	// The shared instance.
	private static ArxNodeNodePlugin plugin;

	/**
	 * The constructor.
	 */
	public ArxNodeNodePlugin() {
		super();
		plugin = this;
	}
	 ...
	 */
	public static ArxNodeNodePlugin getDefault() {
		return plugin;
	}
