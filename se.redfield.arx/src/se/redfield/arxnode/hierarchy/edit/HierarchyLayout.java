...
public class HierarchyLayout<T> {
	 ...
	 * @param model
	 */
	public HierarchyLayout(HierarchyModelGrouping<T> model) {
		this.model = model;
	}
	...
	/**
	 * Computes the cardinalities of the optimal number of elements per hierarchy
	 * level.
	 *
	 * @return
	 */
